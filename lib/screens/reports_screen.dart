...
class ReportsScreen extends StatelessWidget {
  ...
  const ReportsScreen({Key? key, this.collegeName, this.department, this.assignedSemesters}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(child: Center(child: Text('Reports & analytics placeholder', style: TextStyle(fontSize: 16)))),
      ]),
    );
  }
}
